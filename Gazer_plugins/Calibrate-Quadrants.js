...
var calibrateQuadrantsSimple = (function (jspsych){
    const info = {
        name: "calibrate-quadrants-simple",
        parameters: {
            image: {
    ...
    class calibrateQuadrantsSimplePlugin {
        constructor (jsPsych) {
 ...
 // Plugin parameters from the experiment.js file can be accessed keys in the trial object
    ...
    calibrateQuadrantsSimplePlugin.info = info;

    return calibrateQuadrantsSimplePlugin;
}) (jsPsychModule);