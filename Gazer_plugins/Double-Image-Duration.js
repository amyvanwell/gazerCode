...
var doubleImageDuration = (function (jspsych) {
    'use strict';
    ...
    class doubleImageDurationPlugin {
        constructor (jsPsych) {
        ...
        trial(display_element, trial) {
            ...
            LstimBot = LstimTop + stimDims.height;
            LstimLeft = stimDims.left;
            LstimRight = LstimLeft + stimDims.width;

            stimDims = document.getElementById("stimulusRight").getBoundingClientRect();
            RstimTop = stimDims.top;
            RstimBot = RstimTop + stimDims.height;
            RstimLeft = stimDims.left;
            RstimRight = RstimLeft + stimDims.width;
    ...
    doubleImageDurationPlugin.info = info;

    return doubleImageDurationPlugin;
})(jsPsychModule);