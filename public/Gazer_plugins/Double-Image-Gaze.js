    ...
    if (!doubleImageGazeComplete) {
        ...
        if (!webgazerErrorDoubleImageGaze) {
            ...
            if (prediction) {
                ...
                let stim = "";
                if (isLookingAtStimulus(leftStimDims, x, y)) {
                    stim = "left";
                }
                if (isLookingAtStimulus(rightStimDims, x, y)) {
                    stim = "right";
                }
...
jsPsych.plugins['Double-Image-Gaze'] = function () {
    ...
    plugin.trial = function (display_element, trial) {
        ...
        display_element.innerHTML = display_element.innerHTML = "<div id='main'><div id='cross' style='position:absolute;font-size:60px;'>+</div>" + "<img id='stimulusLeft' style='visibility:hidden; padding-right:'" + paddingVal + " src='" + stimLeftGaze + "'>" + "<img id='stimulusRight' style='visibility:hidden; padding-left:" + paddingVal + "px;' src='" + stimRightGaze + "'>" + "</div>";
