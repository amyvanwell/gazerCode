 ...
 * is on the fixation cross, the boolean fixationComplete is defined as true.
 * This function will stop getting re-called when fixationComplete becomes true.
 */

async function analyzeCurrentPoint() {

    // Check if trial is complete or skipped
    if (!fixationComplete && !skippedTrialFixation) {
...
/**
 * @file Single-Cross-Duration Plugin
 * 
...
jsPsych.plugins['Single-Cross-Duration'] = function () {

    var plugin = {};

    plugin.info = {
        name: 'Single-Cross-Duration',
        parameters: {
            duration: {
    ...
    plugin.trial = function (display_element, trial) {
        ...
        // THE FOLLOWING VARIABLES NEED TO BE RESET FOR EACH TRIAL OTHERWISE THEY WILL INTERRUPT THE OTHER TRIALS
