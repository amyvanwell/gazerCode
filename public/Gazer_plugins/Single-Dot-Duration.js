...
jsPsych.plugins['Single-Dot-Duration'] = function () {
    ...
    plugin.trial = function (display_element, trial) {
        ...
        display_element.innerHTML = display_element.innerHTML = "<div id='main'><div id='cross' style='position:absolute;margin-left:-17.5px;font-size:60px;'>+</div>" + "<div id='dotStimulus' class='dotStimulus' style='visibility:hidden;position: absolute; margin-top:" + top + "px; margin-left:" + left + "px;'></div>";
