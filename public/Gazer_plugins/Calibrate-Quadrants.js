...
jsPsych.plugins['Calibrate-Quadrants'] = function () {
    ...
    plugin.info = {
        ...
        display_element.innerHTML = "<div class='main' id='main'><div id='cross' style='visibility:hidden;position:absolute;font-size:60px;'>+</div>" + "<div id='crossRight' style='visibility:hidden; position:absolute;font-size:60px;margin-left:" + crossRight + " '>+</div>" + "<div id='crossLeft' style='visibility:hidden;position:absolute;font-size:60px; margin-left:" + crossLeft + " '>+</div>" + "<div id='crossTop' style='visibility:hidden;position:absolute;font-size:60px;margin-top:" + crossTop + " '>+</div>" + "<div id='crossBot' style='visibility:hidden;position:absolute;font-size:60px; margin-top:" + crossBot + " '>+</div>" + "<img id='stimulus1' style='position: absolute; margin-top:" + top + "px; margin-left:" + left + "px;' src='" + img + "'>" + "<img id='stimulus2' style='visibility:hidden; position: absolute; margin-top:" + top + "px; margin-left:" + right + "px;' src='" + img + "'>" + "<img id='stimulus3' style='visibility:hidden; position: absolute; margin-top:" + bottom + "px; margin-left:" + left + "px;' src='" + img + "'>" + "<img id='stimulus4' style='visibility:hidden; position: absolute; margin-top:" + bottom + "px; margin-left:" + right + "px;' src='" + img + "'>" + "<div class='status' id='status'></div>" + "<button class='acc_btn' id='acc_btn' style='display:none;'>Check Accuracy</button>" + "<div class='accuracy' id='accuracy' style='visibility:hidden;'>We will now test the accuracy of the calibration. When you're ready, look at the center cross and click on the 'Check Accuracy' button. Hold your gaze on the cross for 5 seconds.</div>" + "<div class='timer' id='timer'></div>" + "<div class='instructions' id='instructions'> To calibrate the camera to track your gaze, use the mouse to click on the red star in each picture 5 times, while gazing at it.</div>" + "<button class='btn' id='btn' style='display:none'>Continue</button>" + "<div class = 'reminder' id='reminder'>Important: Hold your head in the same position, only move your eyes between the images.</div></div>";
