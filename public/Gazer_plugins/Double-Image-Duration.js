...
jsPsych.plugins['Double-Image-Duration'] = function () {
    ...
    plugin.trial = function (display_element, trial) {
        ...
        display_element.innerHTML = display_element.innerHTML = "<div id='main'><div id='cross' style='position:absolute;font-size:60px;'>+</div>" + "<img id='stimulusLeft' style='visibility:hidden padding-right:'" + paddingVal + " src='" + stimulusLeft + "'>" + "<img id='stimulusRight' style='visibility:hidden; padding-left:" + paddingVal + "px;' src='" + stimulusRight + "'>" + "</div>";
