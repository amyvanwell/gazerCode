...
jsPsych.plugins['Single-Image-Duration'] = function () {
    ...
    plugin.info = {
        ...
        parameters: {
            duration: {
                ...
                description: 'Duration to display the image in ms, defaults to 1 second.',
                default: 1000
            },
            stimulus: {
    ...
    plugin.trial = function (display_element, trial) {
        ...
        display_element.innerHTML = display_element.innerHTML = "<div id='main'><div id='cross' style='position:absolute;font-size:60px;'>+</div>" + "<img id='stimulus' style='visibility:hidden;' src='" + singleImageDurationStimulus + "'></div>";
