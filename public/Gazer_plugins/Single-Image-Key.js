...
function finishSingleImageKey() {
    ...
    jsPsych.pluginAPI.cancelKeyboardResponse(keyboardEndTrial);
...
jsPsych.plugins['Single-Image-Key'] = function () {
    ...
    plugin.trial = function (display_element, trial) {
        ...
        display_element.innerHTML = display_element.innerHTML = "<div id='main'><div id='cross' style='position:absolute;font-size:60px;'>+</div>" + "<img id='stimulus' style='visibility:hidden;' src='" + stimulus + "'></div>";
        ...
        keyboardEndTrial = jsPsych.pluginAPI.getKeyboardResponse({
